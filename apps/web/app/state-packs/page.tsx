...
export default async function StatePacksPage(): Promise<React.JSX.Element> {
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="mb-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          <li>
            • <strong>Vector-only JSON:</strong> Locations, rulesets, and materials (no map tiles)
          </li>
          <li>
            • <strong>Approved locations only:</strong> All locations have been reviewed and
            approved
          </li>
          <li>
            • <strong>Updated nightly:</strong> Packs are regenerated automatically
          </li>
          <li>
            • <strong>Offline-ready:</strong> Download and use without internet connection
          </li>
          <li>
            • <strong>Private observations excluded:</strong> Only public data included
          </li>
        </ul>
      </div>
      ...
      {packs.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">No state packs available yet</h2>
          <p className="text-gray-600">State packs are generated nightly. Check back soon!</p>
        </div>
      ) : (
      ...
      <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
        ...
        <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded">
          <p className="text-sm text-yellow-800">
            <strong>Note:</strong> State packs do NOT include map tiles or photos. For full map
            functionality, use the online map viewer.
          </p>
        </div>
      </div>
    </div>
