    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <div className="mt-8 bg-gray-50 border border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-3 text-sm text-gray-700">
          <div>
            <strong className="text-gray-900">Full Dataset:</strong> Everything available in a
            single export.
          </div>
          <div>
            <strong className="text-gray-900">Observations:</strong> Field notes and user
            observation entries.
          </div>
          <div>
            <strong className="text-gray-900">Collections/Materials:</strong> Metadata for curated
            sets and materials.
          </div>
        </div>
