...
- First provider candidate: **[First Live Provider Selection R1](FIRST_LIVE_PROVIDER_SELECTION.md)**, **[USGS SGMC Provider Contract](USGS_SGMC_PROVIDER_CONTRACT.md)**, **[USGS SGMC Shadow Read](USGS_SGMC_SHADOW_READ.md)**, and **[USGS SGMC Shadow Certification](USGS_SGMC_SHADOW_CERTIFICATION.md)** — geologic map units for geological context. Certification authorizes a bounded repeated shadow read and does not authorize production ingestion
