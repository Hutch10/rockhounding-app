...
- First provider candidate: **[First Live Provider Selection R1](FIRST_LIVE_PROVIDER_SELECTION.md)**, **[USGS SGMC Provider Contract](USGS_SGMC_PROVIDER_CONTRACT.md)**, **[USGS SGMC Shadow Read](USGS_SGMC_SHADOW_READ.md)**, **[USGS SGMC Shadow Certification](USGS_SGMC_SHADOW_CERTIFICATION.md)**, **[USGS SGMC Bounded Repeated Shadow](USGS_SGMC_BOUNDED_REPEATED_SHADOW.md)**, **[USGS SGMC Production Readiness Gate](USGS_SGMC_PRODUCTION_READINESS_GATE.md)**, and **[USGS SGMC Public Display Rights](USGS_SGMC_PUBLIC_DISPLAY_RIGHTS.md)** — geologic map units for geological context. Public display of DOI `10.5066/F7WH2N65` is allowed with attribution constraints. [Production geological context](USGS_SGMC_PRODUCTION_READ_ONLY_GEOLOGICAL_CONTEXT.md) is `PRODUCTION_READ_ONLY_GEOLOGICAL_CONTEXT` on Site Detail. [Acceptance](USGS_SGMC_PRODUCTION_ACCEPTANCE.md) is conditional until a signed-in browser check. Production ingestion stays closed
