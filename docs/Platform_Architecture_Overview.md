...
- First provider candidate: **[First Live Provider Selection R1](FIRST_LIVE_PROVIDER_SELECTION.md)**, **[USGS SGMC Provider Contract](USGS_SGMC_PROVIDER_CONTRACT.md)**, **[USGS SGMC Shadow Read](USGS_SGMC_SHADOW_READ.md)**, **[USGS SGMC Shadow Certification](USGS_SGMC_SHADOW_CERTIFICATION.md)**, **[USGS SGMC Bounded Repeated Shadow](USGS_SGMC_BOUNDED_REPEATED_SHADOW.md)**, and **[USGS SGMC Production Readiness Gate](USGS_SGMC_PRODUCTION_READINESS_GATE.md)** — geologic map units for geological context. The readiness gate is conditionally ready. Live authority stays `BOUNDED_REPEATED_SHADOW_READ`. Production ingestion stays closed
